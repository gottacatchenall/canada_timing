...
To estimate the time it will take until my application is processed, its worth considering what the value of $E$ really means. It is a _cumulative_ measure of probability, which can have bizzare properties. 
...
We know that $\Pi(\text{77 days}) = 0.8$, and therefore we can place a constaint on the distribution of processing times $\pi(t)$, which is that 
...
This allows us again to set the constaint
